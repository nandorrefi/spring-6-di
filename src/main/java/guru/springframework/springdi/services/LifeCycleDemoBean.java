...
public class LifeCycleDemoBean implements InitializingBean, DisposableBean, BeanNameAware,
    ...
    @Value("${java.specification.version}") //this string is SpEL (Spring Expression Language)
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (bean instanceof MyController){ // since this function runs on every bean it's important to do a type check
    ...
    // from here on you can see the destroy lifecycle //
    @PreDestroy
